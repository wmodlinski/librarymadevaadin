package com.modlinski.librarymadevaadin.books.service;
...
public class BookService {
    ...
    private Set exampleData() {
        ...
        books.add(new Book("The Handmaid's Tale", "Margaret Atwood", "2019", BookType.POETRY));
        books.add(new Book("Watch Us Rise", "Renée Watson,  Ellen Hagan", "2019", BookType.CLASSIC));
        return books;
    }
